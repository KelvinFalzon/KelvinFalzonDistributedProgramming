...
namespace IdentityAPI.Services
{
    public class SubscriberService : IHostedService, IDisposable
    {
        ...
        public SubscriberService(IOptions<GCPSettings> settings, NotificationsService notificationsService)
        {
            subscriptionName = new SubscriptionName(settings.Value.Project, "movies-notification-sub");

            NotificationSubscriptionName = new SubscriptionName(settings.Value.Project, "notification-sub");
